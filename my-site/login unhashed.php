...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
    {
        ...
        if (filter_var($user_name, FILTER_VALIDATE_EMAIL)) {
          $query = "select * from tb_users where email = '$user_name' and password = '$password' limit 1";
        } else {
        ...
        <div >	
          ...
          <form class="card-form" method="post">
            <div class="alternate-input">
              <input type="text" class="alternate-input-field" name="user_name" id="user_name" required/>
              <label class="alternate-input-label" for="user_name" >User Name or E-mail</label>
            </div>
            <div class="alternate-input">
              <input type="password" class="alternate-input-field" name="password" id="password" required/>
              <label class="alternate-input-label" for="password">Password</label>
            </div>
